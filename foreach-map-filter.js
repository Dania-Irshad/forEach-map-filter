...
function vowelCount(str) {
    ...
    newArr.forEach(function (val) {
        ...
        if (vowels.indexOf(lowerCaseVal) !== -1) {
            if (vowelCountObj[lowerCaseVal]) {
                vowelCountObj[lowerCaseVal]++;
            }
            else {
                vowelCountObj[lowerCaseVal] = 1;
            }
        }
    });
...
function removeVowels(str) {
    ...
    let vowels = 'aeiou';
    let newStr = newArr.filter(function(val){
